...
def otsu_binarization(img, th=128):
    ...
    for _t in range(1, 255):
        ...
        m0 = np.mean(v0) if len(v0) > 0 else 0.#对小于和大于阈值的像素值取两个区域的平均值
        w0 = len(v0) / (H * W)#小于threshold的比例
...
def object_area(img):#该函数统计图像非零元素的占比
...
def make_copymove(path1, mask_path):
    ...
    try:
        ...
        print("rate", rate)
        image = mask
        closed = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY) #RGB图像转灰度图像
...
mask = os.listdir("C:/Users/LG/Desktop/coco_test/mask/")
for i in range(len(mask)):
    mask_path = "C:/Users/LG/Desktop/coco_test/mask/" + mask[i]
    image_path = "C:/Users/LG/Desktop/coco_test/img/" + mask[i]
    tam, real_mask, tam_mask, tam_two_mask, tam_two_mask_edge = make_copymove(image_path, mask_path)
    if tam == 0:
        continue
    tam.save("C:/Users/LG/Desktop/coco_test/tam/" + mask[i])
    real_mask.save("C:/Users/LG/Desktop/coco_test/real_mask/" + mask[i])
    tam_mask.save("C:/Users/LG/Desktop/coco_test/tam_mask/" + mask[i])
    tam_two_mask.save("C:/Users/LG/Desktop/coco_test/tam_two_mask/" + mask[i])
    tam_two_mask_edge.save("C:/Users/LG/Desktop/coco_test/tam_two_mask_edge/" + mask[i])